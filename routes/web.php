...
Route::middleware('roles:Admin|Manager')->prefix('/admin')->name('admin-')->group(function() {
    ...
    Route::get('/travels/edit/{hotel}', [TravelController::class, 'edit'])->name('travel-edit');
    Route::put('/travels/edit/{hotel}', [TravelController::class, 'update'])->name('travel-update');
});
