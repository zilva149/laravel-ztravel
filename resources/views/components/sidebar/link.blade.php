...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-[var(--green)] shadow-lg hover:bg-[var(--green)]' : 'text-gray-500 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
