...
<button class="flex gap-2 items-center cursor-pointer" title="{{ $reviews }} atsiliepimai(as)" data-modal-open="rating" data-modal-operation="view" data-modal-route="">
    ...
    <div class="flex gap-0 pointer-events-none">
        ...
        <label for="rate-2" class="fas fa-star text-yellow-500 {{ round($rating) >= 2 ? 'opacity-100' : 'opacity-40' }} pointer-events-none"></label>
        <input type="radio" name="3" id="rate-3" class="hidden">
        <label for="rate-3" class="fas fa-star text-yellow-500 {{ round($rating) >= 3 ? 'opacity-100' : 'opacity-40' }} pointer-events-none"></label>
        <input type="radio" name="4" id="rate-4" class="hidden">
        <label for="rate-4" class="fas fa-star text-yellow-500 {{ round($rating) >= 4 ? 'opacity-100' : 'opacity-40' }} pointer-events-none"></label>
