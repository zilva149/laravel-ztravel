<x-back-layout>
    ...
    <div class="mb-6 flex flex-col gap-6 2xl:flex-row">
        <section class="w-full p-6 bg-white rounded-md shadow-md flex flex-col gap-4 2xl:w-2/3">
        ...
        <section class="w-full p-6 bg-white rounded-md shadow-md flex flex-col gap-4 2xl:w-1/3">
